...
describe "sentence_words/new" do
  before(:each) do
    assign(:sentence_word, stub_model(SentenceWord,
      :position => 1,
      :word => nil,
      :sentence => nil
    ).as_new_record)
  ...
  it "renders new sentence_word form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => sentence_words_path, :method => "post" do
