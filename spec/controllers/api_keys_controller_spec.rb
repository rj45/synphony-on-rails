  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved api_key as @api_key" do
        ...
        post :create, {:api_key => { "user" => "invalid value" }}, valid_session
        assigns(:api_key).should be_a_new(ApiKey)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested api_key" do
        ...
        ApiKey.any_instance.should_receive(:update_attributes).with({ "user" => "" })
        put :update, {:id => api_key.to_param, :api_key => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the api_key as @api_key" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ApiKey.any_instance.stub(:save).and_return(false)
        put :update, {:id => api_key.to_param, :api_key => { "user" => "invalid value" }}, valid_session
        assigns(:api_key).should eq(api_key)
      end
