  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sequence as @sequence" do
        ...
        post :create, {:sequence => { "language_project" => "invalid value" }}, valid_session
        assigns(:sequence).should be_a_new(Sequence)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sequence" do
        ...
        Sequence.any_instance.should_receive(:update_attributes).with({ "language_project" => "" })
        put :update, {:id => sequence.to_param, :sequence => { "language_project" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sequence as @sequence" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sequence.any_instance.stub(:save).and_return(false)
        put :update, {:id => sequence.to_param, :sequence => { "language_project" => "invalid value" }}, valid_session
        assigns(:sequence).should eq(sequence)
      end
